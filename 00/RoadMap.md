...
- [ ] The Bank structure must contain an operator[] to get an account by it’s ID, but
you aren’t allow to make a while or a for loop to find the account corresponding to
such ID
